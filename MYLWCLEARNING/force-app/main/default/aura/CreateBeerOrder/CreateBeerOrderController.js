({
    doInit : function(component, event, helper) {
        ...
        if(pageReference){
            ...
            component.set('v.beerId', state.c__beerId); //a0H2v00000dWuTrEAK //state.beerId
    ...
    handleSubmit : function(component, event, helper) {
        ...
        component.set('v.beerOrder.Street__c', component.get('v.beerOrder.Street__c'));
        component.set('v.beerOrder.City__c', component.get('v.beerOrder.City__c'));
        component.set('v.beerOrder.Country__c', component.get('v.beerOrder.Country__c'));
        component.set('v.beerOrder.State__c', component.get('v.beerOrder.State__c'));
        component.set('v.beerOrder.Postal_Code__c', component.get('v.beerOrder.Postal_Code__c'));
